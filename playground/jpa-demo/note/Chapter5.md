...
- 단방향 매핑과 비교해서 양방향 매핑은 복잡함.
  - 연관관계의 주인도 정해야 하고, 두 개의 단방향 연관관계를 양방향으로 만들기 위해 로직도 잘 관리해야 함 
  - 중요한 사실은 연관관계가 하나인 단방향 매핑은 언제나 연관관계의 주인이라는 점 
- 양방향은 여기에 주인이 아닌 연관관계를 하나 추가했을 뿐
 

결국 단방향과 비교해서 양방향의 장점은 반대방향으로 객체 그래프 탐색 기능이 추가된 것뿐
